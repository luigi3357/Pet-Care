  ...
  return (
    <SafeAreaView>
      ...
      <View>
        ...
        />
        <View>
          {errors.title && <Text className="errors">{errors.title}</Text>}
        </View>
      </View>
      <View
        style={{
      ...
      <View>
        ...
        />
        <View>
          {errors.price && <Text className="errors">{errors.price}</Text>}
        </View>
      </View>
      <View>
        <View>
        ...
        <View>
          {errors.type && <Text className="errors">{errors.type}</Text>}
        </View>
        <View>
      ...
      <View>
        ...
        <View>
          {errors.size && <Text className="errors">{errors.size}</Text>}
        </View>
      ...
      <View>
        ...
        />
        <View>
          {errors.phone && <Text className="errors">{errors.phone}</Text>}
        </View>
      </View>
      ...
      <View>
        ...
        />
        <View>
          {errors.address && <Text className="errors">{errors.address}</Text>}
        </View>
      </View>
...
/>
      ...
      <View>
        <TouchableOpacity disabled={disabled} onPress={(e) => handleSubmit(e)}>
          <Text>Send</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
